...
# Add project root to path so ocr/ package is importable
sys.path.insert(0, str(Path(__file__).parent))

from ocr.engine import get_predictor, extract_words, get_easyocr_reader, extract_words_easyocr
from ocr.name_matching import filter_by_names
from ocr.pipeline import _normalize_heights
from ocr.stabilization import stabilize
from ocr import pipeline as _pipe
