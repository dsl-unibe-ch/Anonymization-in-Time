...
from ait.utils import extract_video_frames, export_ocr_text_timeline, resolve_device, cleanup_device
...
def process_single_video(video_path, output_base_dir, dict_path,
    ...
    # Step 1: Extract frames (auto-skips if existing frames match expected count)
