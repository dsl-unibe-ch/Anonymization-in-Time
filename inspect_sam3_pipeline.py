...
from sam3.engine import setup_predictor, process_image, get_image_files
from sam3.mask_ops import (slim_results, merge_overlapping_in_results,
                           merge_overlapping_in_frame, infer_img_shape)
from sam3.tracking import match_masks_across_frames, propagate_missing_masks
from sam3.circularize import circularize_results
...
def main():
    ...
    import gc
    gc.collect()
    from utils import cleanup_device
